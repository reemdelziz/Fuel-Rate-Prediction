...
export const FuelHistory = () => {
    ...
    return (
        <div className="fuelHistory-wrapper">
            ...
            <h1 className="fuel-history-title">FUEL QUOTE HISTORY</h1>
            <hr className="ml-6	w-10/12 border-white" />
            <div >
                {FuelData.map((dataItem, index) => (
                    <h2 key={index} className="fuel-histroy-titles">quote {dataItem.quoteId}</h2>
                ))}
            </div>
